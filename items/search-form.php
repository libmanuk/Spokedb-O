...
<form <?php echo tag_attributes($formAttributes); ?>>
    ...
    <div id="search-by-range" class="field" style="display:none">
    ...
    <div class="field">
        <?php echo $this->formLabel('collection-search', __('Search By Project')); ?>
        <div class="inputs">
        <?php
            echo $this->formSelect(
                'collection',
    ...
    <div>
        <?php if (!isset($buttonText)) {
            $buttonText = __('Search for interviews');
        } ?>
